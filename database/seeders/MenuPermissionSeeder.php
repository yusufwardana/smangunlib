    ...
    private function menuDefinitions(): array
    {
        ...
        return [
            ...
            ['koleksi', 'Koleksi', 'fa-solid fa-book', 'koleksi.buku.index', ['view'], [
                ...
                ['koleksi.kategori', 'Kategori', 'fa-solid fa-tags', 'koleksi.kategori.index', $crud, []],
                ['koleksi.rak', 'Rak', 'fa-solid fa-layer-group', 'koleksi.rak.index', $crud, []],
                ['koleksi.penulis', 'Penulis', 'fa-solid fa-user-pen', 'koleksi.penulis.index', $crud, []],
                ['koleksi.penerbit', 'Penerbit', 'fa-solid fa-building', 'koleksi.penerbit.index', $crud, []],
                ['koleksi.inventaris', 'Inventaris', 'fa-solid fa-boxes-stacked', 'koleksi.inventaris.index', $crudExport, []],
            ]],

            ['anggota', 'Keanggotaan', 'fa-solid fa-users', 'anggota.index', $crudExport, []],

            ['sirkulasi', 'Sirkulasi', 'fa-solid fa-right-left', 'sirkulasi.index', ['view'], [
                ['sirkulasi.peminjaman', 'Peminjaman', 'fa-solid fa-hand-holding', 'sirkulasi.peminjaman.form', array_merge($crud, ['approve', 'print']), []],
                ['sirkulasi.pengembalian', 'Pengembalian', 'fa-solid fa-rotate-left', 'sirkulasi.pengembalian.form', array_merge($crud, ['approve', 'print']), []],
                ['sirkulasi.reservasi', 'Reservasi', 'fa-solid fa-calendar-check', 'sirkulasi.reservasi.index', array_merge($crud, ['approve']), []],
                ['sirkulasi.denda', 'Denda', 'fa-solid fa-money-bill-wave', 'sirkulasi.denda.index', array_merge($crud, ['approve', 'print']), []],
                ['sirkulasi.pengunjung', 'Pengunjung', 'fa-solid fa-user-check', 'sirkulasi.pengunjung.index', array_merge($crud, ['export_excel']), []],
            ]],
            ...
            ['sarpras', 'Sarpras', 'fa-solid fa-chair', 'sarpras.index', $crud, []],

            ['administrasi', 'Administrasi', 'fa-solid fa-folder-open', 'administrasi.sop', ['view'], [
                ['administrasi.sop', 'SOP', 'fa-solid fa-file-lines', 'administrasi.sop', $crudExport, []],
                ['administrasi.tata_tertib', 'Tata Tertib', 'fa-solid fa-scroll', 'administrasi.tata_tertib', $crudExport, []],
                ['administrasi.struktur', 'Struktur Organisasi', 'fa-solid fa-sitemap', 'administrasi.struktur', $crudExport, []],
            ]],

            ['sistem', 'System Management', 'fa-solid fa-gear', null, ['view'], [
                ['sistem.user', 'User', 'fa-solid fa-users', 'system.users.index', $crud, []],
                ['sistem.role', 'Role', 'fa-solid fa-user-shield', 'system.roles.index', $crud, []],
                ...
                ['sistem.restore', 'Restore', 'fa-solid fa-clock-rotate-left', 'system.restore.index', ['view', 'upload'], []],
                ...
                ['sistem.activity_log', 'Activity Log', 'fa-solid fa-list-check', 'system.activity-log.index', ['view', 'export_excel'], []],
    ...
    private function assignDefaultRolePermissions(): void
    {
        $grants = [
            ...
            'kepala_perpustakaan' => [
                ...
                'sirkulasi.view', 'sirkulasi.peminjaman.view', 'sirkulasi.peminjaman.create', 'sirkulasi.peminjaman.approve',
                'sirkulasi.pengembalian.view', 'sirkulasi.pengembalian.create', 'sirkulasi.denda.view', 'sirkulasi.denda.approve',
                'dokumen.view', 'dokumen.create', 'dokumen.edit', 'dokumen.delete', 'dokumen.download',
                'laporan.view', 'laporan.export_pdf', 'laporan.export_excel', 'laporan.print',
                'literasi.view',
                'sistem.view', 'sistem.setting.view', 'sistem.backup.view', 'sistem.user.view', 'sistem.role.view',
            ],
            'pustakawan' => [
                'dashboard.view',
                ...
                'dokumen.view', 'dokumen.create', 'dokumen.edit', 'dokumen.download',
                'laporan.view',
                'literasi.view',
            ],
            'guru' => [
                ...
                'literasi.view', 'literasi.create', 'literasi.edit',
            ],
            'siswa' => [
                'dashboard.view',
                'koleksi.view', 'koleksi.buku.view',
